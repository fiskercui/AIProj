...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        protected bool m_IsTextParseDirty = true;
        ...
        protected static TMP_TextProcessingStack<MaterialReference> m_materialReferenceStack = new TMP_TextProcessingStack<MaterialReference>(4);
        ...
        protected TMP_TextProcessingStack<float> m_sizeStack = new TMP_TextProcessingStack<float>(2);
        ...
        protected TMP_TextProcessingStack<FontWeight> m_FontWeightStack = new TMP_TextProcessingStack<FontWeight>(2);
        ...
        protected TMP_TextProcessingStack<HorizontalAlignmentOptions> m_lineJustificationStack = new TMP_TextProcessingStack<HorizontalAlignmentOptions>(2);// new HorizontalAlignmentOptions[16]);
       ...
       // protected bool m_hadLayout;
        ...
        protected TMP_TextProcessingStack<float> m_indentStack = new TMP_TextProcessingStack<float>(2);
        ...
        protected TMP_TextProcessingStack<Color32> m_colorStack = new TMP_TextProcessingStack<Color32>(2);// new Color32[16]);
        protected TMP_TextProcessingStack<Color32> m_underlineColorStack = new TMP_TextProcessingStack<Color32>(2); //(new Color32[16]);
        protected TMP_TextProcessingStack<Color32> m_strikethroughColorStack = new TMP_TextProcessingStack<Color32>(2);// (new Color32[16]);
        protected TMP_TextProcessingStack<HighlightState> m_HighlightStateStack = new TMP_TextProcessingStack<HighlightState>(2);// (new HighlightState[16]);

        protected TMP_ColorGradient m_colorGradientPreset;
        protected TMP_TextProcessingStack<TMP_ColorGradient> m_colorGradientStack = new TMP_TextProcessingStack<TMP_ColorGradient>(2);// (new TMP_ColorGradient[16]);
        ...
        protected TMP_TextProcessingStack<int> m_ItalicAngleStack = new TMP_TextProcessingStack<int>(2);
        protected int m_ItalicAngle;

        protected TMP_TextProcessingStack<int> m_actionStack = new TMP_TextProcessingStack<int>(2);

        protected float m_padding = 0;
        protected float m_baselineOffset; // Used for superscript and subscript.
        protected TMP_TextProcessingStack<float> m_baselineOffsetStack = new TMP_TextProcessingStack<float>(2);
        ...
        struct TextBackingContainer
        {
            ...
            {
                m_Array = ListArrayPool<uint>.AlocArray(size);
            ...
            public void Resize(int size)
            {
                ...
                ListArrayPool<uint>.Resize(ref m_Array, size);
        ...
        protected void ParseInputText()
        {
            ...
            //解析过的不再解析
            if (!m_IsTextParseDirty && m_textInfo.characterInfo != null&& m_textInfo.characterInfo.Length>= m_textInfo.characterCount&&m_textInfo.characterCount == text.Length)
            {
                if (IsMaterialChange() == false)
                {
                    //Debug.LogError("ParseInputText 跳过文件解析 ");
                    return;
                }
            }
            m_IsTextParseDirty = false;
        ...
        {
            char[] array = ListArrayPool<char>.AlocArray(m_TextBackingArray.Count);// new char[m_TextBackingArray.Count];
            ...
            ListArrayPool<char>.RecycleArray(array);
            return str;
        }
        ...
        internal virtual bool IsMaterialChange() { return true; }
        ...
        {
            if (null == m_textInfo|| m_textInfo.characterInfo==null|| m_textInfo.characterInfo.Length<= m_characterCount) return;
            ...
            //图片丢失的时候 spriteSheet 为空
            if (m_cached_TextElement == null|| m_cached_TextElement.m_Glyph == null|| m_currentSpriteAsset==null|| m_currentSpriteAsset.spriteSheet==null)
                return;
