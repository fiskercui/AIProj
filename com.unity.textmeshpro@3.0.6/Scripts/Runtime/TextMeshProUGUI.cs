...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI : TMP_Text, ILayoutElement
    {
        ...
        {
            if (this == null || !this.IsActive())//||!IsCanvasActive())
                return;
        ...
        public override void SetLayoutDirty()
        {
            ...
            m_hadLayout = LayoutRebuilder.MarkLayoutForRebuild(this.rectTransform, this);
        ...
        public override Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            {
                Transform rootCanvas = (canvas != null) ? canvas.transform : null;// MaskUtilities.FindRootSortOverrideCanvas(transform);
