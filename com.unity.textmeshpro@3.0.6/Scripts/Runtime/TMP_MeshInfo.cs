...
namespace TMPro
{
    ...
    public struct TMP_MeshInfo
    {
        ...
        public void Reset()
        {
            ...
            ListArrayPool<Vector3>.RecycleArray(vertices);
            vertices = null;
            ListArrayPool<Vector3>.RecycleArray(normals);
            normals = null;
            ListArrayPool<Vector4>.RecycleArray(tangents);
            tangents = null;
            ListArrayPool<Vector2>.RecycleArray(uvs0);
            uvs0 = null;
            ListArrayPool<Vector2>.RecycleArray(uvs2);
            uvs2 = null;
            ListArrayPool<Color32>.RecycleArray(colors32);
            colors32 = null;
            ListArrayPool<int>.RecycleArray(triangles);
            triangles = null;
        ...
        public void Rebuild(Mesh mesh, int size)
        {
            Reset();
            ...
            this.vertices = ListArrayPool<Vector3>.AlocArray(sizeX4); //new Vector3[sizeX4];
            this.uvs0 = ListArrayPool<Vector2>.AlocArray(sizeX4); //new Vector2[sizeX4];
            this.uvs2 = ListArrayPool<Vector2>.AlocArray(sizeX4); //new Vector2[sizeX4];
            //this.uvs4 = new Vector2[sizeX4]; // SDF scale data
            this.colors32 = ListArrayPool<Color32>.AlocArray(sizeX4);// new Color32[sizeX4];

            this.normals = ListArrayPool<Vector3>.AlocArray(sizeX4);// new Vector3[sizeX4];
            this.tangents = ListArrayPool<Vector4>.AlocArray(sizeX4);// new Vector4[sizeX4];

            this.triangles = ListArrayPool<int>.AlocArray(sizeX6);// new int[sizeX6];
        ...
        public TMP_MeshInfo(Mesh mesh, int size, bool isVolumetric)
        {
            ...
            this.vertices = ListArrayPool<Vector3>.AlocArray(size_x_s0); //new Vector3[sizeX4];
            this.uvs0 = ListArrayPool<Vector2>.AlocArray(size_x_s0); //new Vector2[sizeX4];
            this.uvs2 = ListArrayPool<Vector2>.AlocArray(size_x_s0); //new Vector2[sizeX4];
            //this.uvs4 = new Vector2[sizeX4]; // SDF scale data
            this.colors32 = ListArrayPool<Color32>.AlocArray(size_x_s0);// new Color32[sizeX4];

            this.normals = ListArrayPool<Vector3>.AlocArray(size_x_s0);// new Vector3[sizeX4];
            this.tangents = ListArrayPool<Vector4>.AlocArray(size_x_s0);// new Vector4[sizeX4];

            this.triangles = ListArrayPool<int>.AlocArray(size_x_s1);// new int[sizeX6];
        ...
        public void ResizeMeshInfo(int size)
        {
            ...
            ListArrayPool<Vector3>.Resize(ref this.vertices, size_X4);
            ListArrayPool<Vector3>.Resize(ref this.normals, size_X4);
            ListArrayPool<Vector4>.Resize(ref this.tangents, size_X4);

            ListArrayPool<Vector2>.Resize(ref this.uvs0, size_X4);
            ListArrayPool<Vector2>.Resize(ref this.uvs2, size_X4);
            //Array.Resize(ref this.uvs4, size_X4);

            ListArrayPool<Color32>.Resize(ref this.colors32, size_X4);

            ListArrayPool<int>.Resize(ref this.triangles, size_X6);
