...
namespace TMPro
{
    ...
    public struct TMP_CharacterInfo
    {
        ...
        public void Reset()
        {
            character = '\0'; // Should be changed to an uint to handle UTF32
        /// <summary>
        /// Index of the character in the raw string.
        /// </summary>
           index = 0; // Index of the character in the input string.
           stringLength = 0;
           elementType = TMP_TextElementType.Character;
        ...
        vertexIndex = 0;
        vertex_BL = TMP_Vertex.zero;
        vertex_TL = TMP_Vertex.zero;
        vertex_TR = TMP_Vertex.zero;
        vertex_BR = TMP_Vertex.zero;
        ...
        aspectRatio = 0;
        scale = 0;
        color = underlineColor = strikethroughColor = highlightColor;
        underlineVertexIndex = 0;
        strikethroughVertexIndex = 0;
        highlightState.color  = highlightColor;
